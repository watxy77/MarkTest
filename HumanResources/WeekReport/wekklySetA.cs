...
{
    public partial class wekklySetA : Form
    {
        public wekklySetA()
        {
            InitializeComponent();
        ...
        private void wekklySetA_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (humanresourcesDataSet.weeklyc_particularsRow item in this.humanresourcesDataSet1.weeklyc_particulars)
                {
                    ...
                    tb1.Location = new Point(272, i * 20 + 60);
                    tb1.Name = "tx1_" + i;
                    ...
                    tb2.Location = new Point(542, i * 20 + 60);
                    tb2.Name = "tx2_" + i;
                ...
                foreach (humanresourcesDataSet.weeklyc_particularsRow item in this.humanresourcesDataSet1.weeklyc_particulars)
                {
                    ...
                    lab.Text = item.WCP_name;
                    lab.Size = new Size(150, 12);
                    lab.Location = new Point(25, i * 20 + 55);
                    this.groupBox2.Controls.Add(lab);

                    TextBox tb = new TextBox();
                    tb.Text = item.WCP_value.ToString();
                    tb.Size = new Size(65, 12);
                    tb.Location = new Point(177, i * 20 + 55);
                    tb.Name = "ltx_" + i;
                    ...
                    tb1.Text = item.WCP_E;
                    tb1.Size = new Size(250, 12);
                    tb1.Location = new Point(272, i * 20 + 55);
                    tb1.Name = "ltx1_" + i;
                    ...
                    tb2.Text = item.WCP_S;
                    tb2.Size = new Size(89, 12);
                    tb2.Location = new Point(542, i * 20 + 55);
                    tb2.Name = "ltx2_" + i;
                    this.groupBox2.Controls.Add(tb2);
                    i++;
                }

                this.tableAdapterManager1.weeklyc_particularsTableAdapter.FillBytype_uf(this.humanresourcesDataSet1.weeklyc_particulars, 2, 2);
                i = 0;
                foreach (humanresourcesDataSet.weeklyc_particularsRow item in this.humanresourcesDataSet1.weeklyc_particulars)
                {
                    Label lab = new Label();
                    lab.Text = item.WCP_name;
                    lab.Size = new Size(150, 12);
                    lab.Location = new Point(25, i * 10 + 30);
                    this.groupBox3.Controls.Add(lab);

                    TextBox tb = new TextBox();
                    tb.Text = item.WCP_value.ToString();
                    tb.Size = new Size(450, 12);
                    tb.Location = new Point(177, i * 10 + 30);
                    tb.Name = "lltx_" + i;
                    this.groupBox3.Controls.Add(tb);

                    TextBox tb1 = new TextBox();
                    tb1.Text = item.WCP_E;
                    tb1.Size = new Size(450, 12);
                    tb1.Location = new Point(177, i * 10 + 55);
                    tb1.Name = "lltx1_" + i;
                    this.groupBox3.Controls.Add(tb1);

                    TextBox tb2 = new TextBox();
                    tb2.Text = item.WCP_S;
                    tb2.Size = new Size(450, 12);
                    tb2.Location = new Point(177, i * 10 + 85);
                    tb2.Name = "lltx2_" + i;
